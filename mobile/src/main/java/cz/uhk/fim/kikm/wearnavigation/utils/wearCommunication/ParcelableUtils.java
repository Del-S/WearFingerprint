...
class ParcelableUtils {
     ...
     */
    static void putParcelable(DataMap dataMap, String key, Parcelable parcelable) {
     ...
     */
    static <T> T getParcelable(DataMap dataMap, String key, Parcelable.Creator<T> creator) {
