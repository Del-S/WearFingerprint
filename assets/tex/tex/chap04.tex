...
\begin{table}[h]
	\begin{center}
		...
		\begin{tabular}{| m{3.5cm} | p{2.2cm} | p{2.5cm} | l |}
			...
			Huawei Watch 2 & Yes / Yes & Yes & \begin{tabular}[c]{@{}l@{}} First update can take a long time. \\ Slight Bluetooth pairing. \end{tabular} \\ \hline
			Polar M600 & Yes / Yes & Yes & \begin{tabular}[c]{@{}l@{}} Polar support complains. \\ Phone synchronization. \\ GPS location. \end{tabular} \\ \hline
		...
		\end{tabular}}
		\caption{Smartwatch comparison (sources: \cite{BAWW, })}
	\end{center}
\end{table}
